...
//             </div>
//             <div className={styles.proof_desc}>
//               Printify has been a amazing partner to work with as we grow our
//               business, from the range of merch we can make for our customers to
//               working with our Customer Service team (Hi Martin!) it's truly
...
//               Unicorn was only supposed to be my design on a white shirt. It is
//               so much more. Printify allows me the time to run the business and
          ...
          >
            ...
            <SwiperSlide>
              <div className={styles.social_proofWrapper}>
                ...
                <div className={styles.proof_desc}>
                  ...
                  unable to keep large amounts of inventory...
                </div>
              </div>
            </SwiperSlide>
            ...
            <SwiperSlide>
              <div className={styles.social_proofWrapper}>
                ...
                <div className={styles.proof_desc}>
                  We chose Printify because of their offerings and low prices...
                </div>
              </div>
            </SwiperSlide>
            ...
            <SwiperSlide>
              <div className={styles.social_proofWrapper}>
                ...
                <div className={styles.proof_desc}>
                  Printify has been amazing for our business growth...
                </div>
              </div>
            </SwiperSlide>
            ...
            <SwiperSlide>
              <div className={styles.social_proofWrapper}>
                ...
                <div className={styles.proof_desc}>
                  Customer service is always quick to respond and resolve issues...
                </div>
              </div>
            </SwiperSlide>
            ...
            <SwiperSlide>
              <div className={styles.social_proofWrapper}>
                ...
                <div className={styles.proof_desc}>
                  I really appreciate working with Printify on my brand...
                </div>
              </div>
            </SwiperSlide>
          </Swiper>
